...
ROOT_PATH = '/scratch/users/muth9/simsiam/particle_picking/data'  # Data path

# Input STAR file with segmentations
in_star = ROOT_PATH + '/test_time_limit_arsens_vol.star'
...
for pr_id, pr in zip(iter(processes.keys()), iter(processes.values())):
    ...
    print('stuck in for loop')
print('not stuck in for loop')
